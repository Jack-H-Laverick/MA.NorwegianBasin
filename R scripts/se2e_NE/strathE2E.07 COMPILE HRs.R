...
Harvest_ratios <- readRDS("I:/Science/MS/users/academics/Laverick_Jack/i-Documents/M-atlantic/Norwegian Basin/Data/Fishing_objects_01_25_TG/Data/Norwegian_sea_Tanguy2/Norwegian_sea/2010-2019/Object/Harvest_ratios.rds") %>% 
  .[-c(5,6,12)]
